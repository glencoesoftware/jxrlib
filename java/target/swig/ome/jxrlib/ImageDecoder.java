...
class ImageDecoder {
  ...
  public long getBytesPerPixel() {
    return JXRJNI.ImageDecoder_getBytesPerPixel(swigCPtr, this);
  }
  ...
  public void getRawBytes(java.nio.ByteBuffer NIOBUFFER) {
  assert NIOBUFFER.isDirect() : "Buffer must be allocated direct.";
    {
      JXRJNI.ImageDecoder_getRawBytes(swigCPtr, this, NIOBUFFER);
    }
  }

  public byte[] getByteArray() {
    return JXRJNI.ImageDecoder_getByteArray(swigCPtr, this);
  }
